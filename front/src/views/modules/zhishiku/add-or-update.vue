<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="文件" prop="wenjian">
          <file-upload
          tip="点击上传文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.wenjian" label="文件" prop="wenjian">
            <el-button type="text" size="small" @click="download(ruleForm.wenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springboote51e2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

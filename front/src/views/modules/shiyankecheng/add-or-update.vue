<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="实验日期" prop="shiyanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.shiyanriqi" 
                type="date"
                placeholder="实验日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shiyanriqi" label="实验日期" prop="shiyanriqi">
              <el-input v-model="ruleForm.shiyanriqi" 
                placeholder="实验日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="实验内容" prop="shiyanneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyanneirong" label="实验内容" prop="shiyanneirong">
                    <span>{{ruleForm.shiyanneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="实验要求" prop="shiyanyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyanyaoqiu" label="实验要求" prop="shiyanyaoqiu">
                    <span>{{ruleForm.shiyanyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='shiyanriqi'){
            this.ruleForm.shiyanriqi = obj[o];
	    this.ro.shiyanriqi = true;
            continue;
          }
          if(o=='shiyanshihao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shiyankecheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shiyankechengCrossAddOrUpdateFlag = false;
                  this.parent.search();

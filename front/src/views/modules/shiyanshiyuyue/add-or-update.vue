<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约内容" prop="yuyueneirong">
          <el-input v-model="ruleForm.yuyueneirong" 
              placeholder="预约内容" clearable  :readonly="ro.yuyueneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预约内容" prop="yuyueneirong">
              <el-input v-model="ruleForm.yuyueneirong" 
                placeholder="预约内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约时间" prop="yuyueshijian">
          <el-input v-model="ruleForm.yuyueshijian" 
              placeholder="预约时间" clearable  :readonly="ro.yuyueshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预约时间" prop="yuyueshijian">
              <el-input v-model="ruleForm.yuyueshijian" 
